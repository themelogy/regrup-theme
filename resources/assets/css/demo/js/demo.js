jQuery(document).ready(function ($) {
    ...
    if (getCookie('ct_simpl.switcher') == 'hide') {
        hideStyleswitcher();
    }

    /** style chooser show/hide **/
    jQuery("#stylechooser  #styleToggle").click(function () {
        setCookie('ct_simpl.switcher', $chooser.css('left') == '0px' || $chooser.css('left') == '-1px' ? 'hide' : 'show');
    ...
    function store() {
        ...
        setCookie('ct_simpl', r);
    }

    function load() {
        d = getCookie('ct_simpl');
        if (d) {
