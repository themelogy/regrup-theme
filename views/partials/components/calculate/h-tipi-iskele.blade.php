...
@else
<h4 class="uppercase motive"><strong>H TİPİ İSKELE HESABI</strong></h4>
@endif
...
<form id="form3" class="form-horizontal" name="form1" method="post">
    ...
    <div class="control-group">
        <div class="controls">
            <button type="button" onclick="htipi_calc('#form3');" class="btn btn-brick btn-xs large-padding pull-left"
